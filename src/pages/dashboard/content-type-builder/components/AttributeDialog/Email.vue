<template>
  <v-dialog v-model="isOpen" width="800">
    <v-card>
      <v-card-title class="pt-4 text-center"> Add new Email field </v-card-title>
      <v-row class="pa-12">
        <v-col>
...
watch(
  ...
  () => {
    if (attribute.value !== null) {
      isUseMaxLength.value = !!((attribute.value as CollationTypeAttributeString).maxLength);
      isUseMinLength.value = !!((attribute.value as CollationTypeAttributeString).minLength);
      form.value = {
