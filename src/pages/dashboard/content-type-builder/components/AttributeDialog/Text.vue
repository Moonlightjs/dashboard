                ...
                <v-col>
                  ...
                  <div>
                    ...
                    <v-radio-group v-model="form.type">
                      <v-radio label="Short text" value="string"></v-radio>
                      <v-radio label="Long text" value="text"></v-radio>
                    </v-radio-group>
                  </div>
                </v-col>
              </v-row>
              ...
              <v-row>
                <v-col>
                  <v-row>
                    ...
                    >
                    <v-col cols="6"
                      ><v-text-field type="text" v-model="form.regex">
                        <template v-slot:label>
                          <div>RegExp pattern</div>
                        </template>
                      </v-text-field></v-col
                    >
                  </v-row>
...
const isUseMinLength = ref<boolean>(false);
const isUseMaxLength = ref<boolean>(false);
...
watch(
  () => isUseMinLength.value,
  () => {
    if (!isUseMinLength.value) {
...
watch(
  () => isUseMaxLength.value,
  () => {
    if (!isUseMaxLength.value) {
...
watch(
  ...
  () => {
    form.value.maxLength = Number(form.value.maxLength) || form.value.maxLength;
    form.value = { ...form.value };
  }
);
...
watch(
  ...
  () => {
    form.value.minLength = Number(form.value.minLength) || form.value.minLength;
    form.value = { ...form.value };
  }
);
...
watch(
  ...
  () => {
    if (attribute.value !== null) {
      isUseMaxLength.value = !!(attribute.value as CollationTypeAttributeString)
        .maxLength;
      isUseMinLength.value = !!(attribute.value as CollationTypeAttributeString)
        .minLength;
      form.value = {
