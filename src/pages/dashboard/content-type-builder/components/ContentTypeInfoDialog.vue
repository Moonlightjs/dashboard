<template>
  <v-dialog v-model="isOpen" width="800">
    <v-card>
      <v-card-title> Create a collection type </v-card-title>
      <v-row class="pa-12">
        <v-col>
            ...
            <v-window-item value="advanced">
              <v-row>
                <v-col>
                  ...
                  <v-switch
                    color="primary"
                    v-model="data.options.draftAndPublish"
                    hide-details
                    inset
                  ></v-switch>
                </v-col>
                <v-col>
                  ...
                  <v-switch
                    color="primary"
                    v-model="data.options.softDelete"
                    hide-details
                    inset
                  ></v-switch>
                </v-col>
      ...
      <v-card-actions class="d-flex justify-space-between px-12 pb-6">
        ...
        <div>
          <v-btn v-if="data.uid.length" color="secondary" @click="onDelete(data.uid)">Delete</v-btn>
