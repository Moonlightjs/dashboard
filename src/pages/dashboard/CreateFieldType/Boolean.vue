            ...
            <v-window-item value="advanced">
              <v-row>
                <v-col>
                  <v-row>
                    <v-col cols="6">
                      <v-select v-model="form.defaultValue" :items="defVal" label="Default value" persistent-hint
...
const initialValue: AttributeField = {
  ...
  name: "",
  defaultValue: 'null',
  icon: 'src/assets/images/boolean-icon.svg',
  type: 'boolean'
};
